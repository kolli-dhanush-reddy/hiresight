...
-- NOTE: predicted_percentage and trend columns are added in migration 20260320160000
-- so we only insert base columns here
INSERT INTO public.department_placements (year, department, placed, total, percentage) VALUES
  ...
  (2022, 'ECE',  295, 325, 90),
  (2022, 'EEE',  185, 210, 88),
  (2022, 'MECH', 145, 180, 80),
  (2022, 'CIVIL', 91, 125, 72),
  (2021, 'CSE',  310, 360, 86),
  (2021, 'ECE',  175, 205, 85),
  (2021, 'EEE',  110, 130, 84),
  (2021, 'MECH',  95, 125, 76),
